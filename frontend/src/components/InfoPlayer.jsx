            ...
            return (
              <div className='info--player__content'>
                <section className='info--player__part--image'>
                  <h4 className='sr-only'>photo</h4>
                  <figure style={{ backgroundImage: `url(${photo.photoUrl})` }}>
                    <figcaption>
                        <a href={photo.authorUrl} onClick={(e) => e.stopPropagation()}>{photo.author}</a>
                ...
                >
                  <h4 className='sr-only'>Basic info</h4>
                ...
                <section className='info--player__part--personal'>
                  <h4 className='sr-only'>BIRTHPLACE</h4>
                  <dl className='info--player__dl'>
                    <dt>
                ...
                <section className='info--player__part--personal'>
                  <h4 className='sr-only'>RESIDENCE</h4>
                  <dl className='info--player__dl'>
                    <dt>
                      <span>RESIDENCE</span>
                    </dt>
                ...
                <section className='info--player__part--personal'>
                  <h4 className='sr-only'>HEIGHT</h4>
                  <dl className='info--player__dl'>
                    <dt>
                      <span>HEIGHT</span>
                    </dt>
                ...
                <section className='info--player__part--personal'>
                  <h4 className='sr-only'>TURN PRO</h4>
                  <dl className='info--player__dl'>
                    <dt>
                      <span>TURN PRO</span>
                    </dt>
                ...
                <section className='info--player__part--personal'>
                  <h4 className='sr-only'>EARNED MONEY</h4>
                  <dl className='info--player__dl'>
                    <dt>EARNED MONEY</dt>
                    <dd>
                      <span>{money ?? 'n/a'}</span>
